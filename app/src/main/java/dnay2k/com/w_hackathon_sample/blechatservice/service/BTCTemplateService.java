...
import dnay2k.com.w_hackathon_sample.R;
import dnay2k.com.w_hackathon_sample.blechatservice.BleManager;
import dnay2k.com.w_hackathon_sample.blechatservice.ConnectionInfo;
import dnay2k.com.w_hackathon_sample.blechatservice.TransactionBuilder;
import dnay2k.com.w_hackathon_sample.blechatservice.TransactionReceiver;
import dnay2k.com.w_hackathon_sample.blechatservice.http.HttpAsyncTask;
import dnay2k.com.w_hackathon_sample.blechatservice.http.HttpInterface;
import dnay2k.com.w_hackathon_sample.blechatservice.http.HttpListener;
...
//		mCommandParser = new CommandParser();
	...
	private void sendMessageToDevice(String message) {
		if(message == null || message.length() < 1)
			return;
		Log.d(TAG, "sendMessageToDevice is running!!");
     ...
     * @param address  The Adress for BluetoothDevice to connect
     */
