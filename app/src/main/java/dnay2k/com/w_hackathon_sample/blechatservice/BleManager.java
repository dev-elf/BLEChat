package dnay2k.com.w_hackathon_sample.blechatservice;
...
/**
 * 블루투스4.0 BLE(Bluetooth Low Energy)를 이용하여 연결을 하기 위한 메소드들이 있습니다.
 * BleManager의 역할은 블루투스와 연결이 되기전부터 연결, 연결 종료까지 모든 상황에 알맞는 메소드들을 호출해주는 디자인 패턴입니다.
 * 싱글턴의 개념인가? 이건 잘 모르겠습니다.
 */
